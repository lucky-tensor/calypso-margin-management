        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label htmlFor="field-uom" className="block text-sm font-medium text-zinc-700 mb-1">
                  Unid. de medida
                </label>
                <select
                  id="field-uom"
            ...
            <div>
              <label htmlFor="field-notes" className="block text-sm font-medium text-zinc-700 mb-1">
            ...
            {selectedProduct ? (
              <>
                ...
                <div className="bg-zinc-50 rounded-xl border border-zinc-200 p-4">
                  ...
                  <p className="text-sm text-zinc-800">{getProductContextLine(selectedProduct)}</p>
                </div>
                  ...
                  <div className="bg-zinc-50 rounded-xl border border-zinc-200 p-4 space-y-2">
                    ...
                    {isFractionalEaches && (
                      <div className="mt-2 bg-amber-50 border border-amber-200 rounded-lg p-2.5 text-xs text-amber-700">
                        Unidade fracionada — verifique com operacoes se deve arredondar ou cortar
                      </div>
                    )}
                  </div>
                ) : (
